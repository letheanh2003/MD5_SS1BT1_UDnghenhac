...
public class SongController {
    ...
    public String showListSong(Model model) {
        List<songList> list = songService.findAll();
    ...
    public ModelAndView saveProduct(@ModelAttribute SongForm songForm) {
        ...
        songList song = new songList(songForm.getId(),songForm.getSongName(),songForm.getArtistName(),songForm.getKindOfMusic(), fileName);
